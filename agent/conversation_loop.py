...
def _billing_or_entitlement_message(
    *,
    ...
    lines = [
        ...
        "Check your provider billing/credits and then retry.",
    ]
...
def run_conversation(
    ...
    if final_response is None and (
        ...
        # Route iteration exhaustion through _record_task_failure so the
        # dispatcher's consecutive-failure circuit breaker can trip. Avoid
        # duplicate closeout if this turn already emitted a successful
        ...
        if not _turn_has_successful_terminal_kanban_closeout(
            ...
            if _kanban_task:
                try:
                    ...
                    _store = _kanban_store(board=None)
                    try:
                        _store.record_task_failure(
                            _kanban_task,
                            error=(
