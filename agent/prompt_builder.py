...
KANBAN_GUIDANCE = (
    ...
    "- Do not copy, replace, repair, VACUUM, checkpoint, or otherwise "
    "mutate `~/.hermes/kanban.db` / `$HERMES_KANBAN_DB` from a worker. If the "
    "board DB appears corrupt or kanban tools fail with SQLite errors, call "
    "`kanban_block(reason=\"kanban-db-corruption: ...\")` and stop so "
    "Grace/Jensen can run the quiesced repair path.\n"
